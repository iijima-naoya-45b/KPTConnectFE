...
const GrowthScoreCard: React.FC<GrowthScoreCardProps> = ({ growthScore }) => {
  ...
  return (
    <div className='bg-white shadow rounded-lg p-6'>
      <div className='mb-6'>
        <h2 className='text-xl font-semibold text-gray-900 mb-2'>🎯 成長スコア分析</h2>
      ...
      <div className='mb-8 p-6 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg border border-indigo-100'>
        <div className='flex items-center justify-between mb-4'>
          <h3 className='text-lg font-semibold text-gray-900'>総合成長スコア</h3>
          <div
            className={`flex items-center space-x-2 px-3 py-1 rounded-full ${overallDisplay.bgColor}`}
          >
        ...
        <div className='flex items-end space-x-4'>
          <div className={`text-4xl font-bold ${getScoreColor(growthScore.overall)}`}>
            {growthScore.overall}
          </div>
          <div className='flex-1'>
            <div className='w-full bg-gray-200 rounded-full h-3'>
              <div
                className={`h-3 rounded-full transition-all duration-500 ${getProgressColor(growthScore.overall)}`}
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
        ...
        <div className='p-4 bg-blue-50 rounded-lg border border-blue-100'>
          <div className='flex items-center justify-between mb-3'>
            <div className='flex items-center space-x-2'>
              ...
              <h4 className='font-semibold text-gray-900'>Keep</h4>
            </div>
            <div
          ...
          <div className={`text-2xl font-bold ${getScoreColor(growthScore.keep)} mb-2`}>
            {growthScore.keep}
          </div>
          ...
          <p className='text-xs text-gray-600 mt-2'>継続的な取り組みの維持度</p>
        </div>
        ...
        <div className='p-4 bg-red-50 rounded-lg border border-red-100'>
          ...
          <div className={`text-2xl font-bold ${getScoreColor(growthScore.problem)} mb-2`}>
            {growthScore.problem}
          </div>
          ...
          <p className='text-xs text-gray-600 mt-2'>問題解決の効率性</p>
        </div>
        ...
        <div className='p-4 bg-green-50 rounded-lg border border-green-100'>
          <div className='flex items-center justify-between mb-3'>
            <div className='flex items-center space-x-2'>
              ...
              <h4 className='font-semibold text-gray-900'>Try</h4>
            </div>
            <div
          ...
          <div className={`text-2xl font-bold ${getScoreColor(growthScore.try)} mb-2`}>
            {growthScore.try}
          </div>
          ...
          <p className='text-xs text-gray-600 mt-2'>新しい取り組みの実行力</p>
        </div>
      </div>

      {/* スコア評価基準 */}
      <div className='mt-6 p-4 bg-gray-50 rounded-lg'>
        <h4 className='text-sm font-semibold text-gray-700 mb-2'>評価基準</h4>
