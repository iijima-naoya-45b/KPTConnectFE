      ...
      <main className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
        <form onSubmit={handleSubmit} className='space-y-8'>
          ...
          <div>
            ...
            <form onSubmit={e => handleAddItem('keep', e)} className='flex gap-2 mb-4'>
              <input
                type='text'
                value={newItem}
          ...
          <div>
            ...
            <form onSubmit={e => handleAddItem('problem', e)} className='flex gap-2 mb-4'>
              <input
                type='text'
                value={newItem}
                onChange={e => setNewItem(e.target.value)}
          ...
          <div>
            ...
            <form onSubmit={e => handleAddItem('try', e)} className='flex gap-2 mb-4'>
              <input
                type='text'
                value={newItem}
                onChange={e => setNewItem(e.target.value)}
