          ...
          <div className="px-6 py-4 border-b border-gray-200">
            ...
            <ul className="space-y-2">
              {kpt.keep.map((item, index) => (
                <li
                  key={index}
                  className="bg-indigo-50 p-3 rounded-md text-indigo-900"
                >
                  {item}
                </li>
              ))}
          ...
          <div className="px-6 py-4 border-b border-gray-200">
            ...
            <ul className="space-y-2">
              {kpt.problem.map((item, index) => (
                <li
                  key={index}
                  className="bg-red-50 p-3 rounded-md text-red-900"
                >
                  {item}
                </li>
              ))}
          ...
          <div className="px-6 py-4">
            ...
            <ul className="space-y-2">
              {kpt.try.map((item, index) => (
                <li
                  key={index}
                  className="bg-green-50 p-3 rounded-md text-green-900"
                >
                  {item}
                </li>
              ))}
